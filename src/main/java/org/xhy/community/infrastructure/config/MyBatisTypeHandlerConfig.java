...
public class MyBatisTypeHandlerConfig {
    ...
    public void registerTypeHandlers() {
        ...
        typeHandlerRegistry.register(ResourceTargetType.class, new ResourceTargetTypeConverter());
        // AI日报相关
        ...
        typeHandlerRegistry.register(SummaryTargetType.class, new SummaryTargetTypeConverter());
